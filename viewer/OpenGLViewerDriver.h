...
class OpenGLViewerTwoPhase : public OpenGLViewer
{typedef OpenGLViewer Base;
public:
	virtual void Initialize();
	virtual void Initialize_Data();
...
class OpenGLViewerParticleALEFoam : public OpenGLViewer
{
	typedef OpenGLViewer Base;
public:
	virtual void Initialize();
...
class OpenGLViewerParticleALEFoamMany : public OpenGLViewer
{
	typedef OpenGLViewer Base;
public:
	virtual void Initialize();
...
class OpenGLViewerElastocap : public OpenGLViewer
{
	typedef OpenGLViewer Base;
public:
	virtual void Initialize();
...
class OpenGLViewerRigid : public OpenGLViewer
{
	typedef OpenGLViewer Base;
public:
	virtual void Initialize();
...
class OpenGLViewerThinShell : public OpenGLViewer
{
	typedef OpenGLViewer Base;
public:
	virtual void Initialize();
