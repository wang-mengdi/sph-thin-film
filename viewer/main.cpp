...
int main(int argc,char* argv[])
{
	...
	parse_args.Add_String_Argument("-o", "D:/Codes/auxplex/data/vortex", "data path");
	parse_args.Add_String_Argument("-oo","","offscreen rendering output");
	parse_args.Add_String_Argument("-m","fluid");
	...
	else if(mode=="two_phase"){viewer.reset(new OpenGLViewerTwoPhase());}
	...
	else if (mode == "particle_foam") { viewer.reset(new OpenGLViewerParticleALEFoam()); }
	else if (mode == "particle_foam_many") { viewer.reset(new OpenGLViewerParticleALEFoamMany()); }
	...
	else if (mode == "elastocap") { viewer.reset(new OpenGLViewerElastocap()); }
	...
	else if (mode == "rigid") { viewer.reset(new OpenGLViewerRigid()); }
	else if (mode == "thin_shell") { viewer.reset(new OpenGLViewerThinShell()); }
